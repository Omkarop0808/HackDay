...
function SavingsScene({ data, colors }) {
  ...
  const monthlySavings = parseInt(data?.monthlySavings, 10) || 0;
  const savingsGoal = parseInt(data?.savingsGoal, 10) || 0;
  const currentSavings = parseInt(data?.currentSavings, 10) || 0;
  const savingsRate = parseInt(data?.savingsRate, 10) || 0;
