...
function CouncilSynthesis() {
  ...
  const fetchSynthesis = useCallback(async (showToast = false) => {
    ...
    try {
      ...
      const response = await axios.get(`${API_URL}/api/synthesis/${user.uid}?timeframe=${timeframe}`);
        ...
        <div className="flex items-center gap-3 self-start md:self-center">
          <Select value={timeframe} onValueChange={setTimeframe}>
            ...
            <SelectContent>
              ...
              <SelectItem value="cycle">7-Week Cycle</SelectItem>
            </SelectContent>
          </Select>
          <Button
            variant="outline"
