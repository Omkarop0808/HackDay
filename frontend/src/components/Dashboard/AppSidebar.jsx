import { LogOut, User, Moon, Sun, LayoutDashboard, GraduationCap, Receipt, Target, Wallet, PiggyBank, TrendingDown, TrendingUp, Users, CandlestickChart, Activity, Clock, Tv2, ChevronDown, EyeOff, Eye, MessageCircle, Umbrella } from "lucide-react"
...
// Menu items. Adapted for FinSage (Fintech for Students)
const itemGroups = {
  main: {
    label: "Main",
    items: [
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link to="/dashboard">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">FinSage</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
